...
// Post-process pergamen decor: resize 7 seals + corner + wax-seal + bookmark + divider-seal
// na cílové rozměry. logo, medailon, big-book ponecháváme v originálních rozměrech.
...
const DECOR = path.resolve('public/themes/pergamen/decor');
