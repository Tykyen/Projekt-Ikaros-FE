/**
 * D-080a (07-migrace-napovedy §3) — toolbox „Co máš po ruce" jako data
 * v registru Vypravěče. Obsah přesunut 1:1 z `features/world/help/toolboxItems.tsx`
 * (tam zůstává re-export pro zpětnou kompatibilitu). 1:1 zdroj kontextových
 * karet pro scope svět; `WorldToolboxPanel` je renderer registru.
 */
