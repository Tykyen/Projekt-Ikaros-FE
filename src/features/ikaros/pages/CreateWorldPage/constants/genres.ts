...
export const GENRES: GenreOption[] = [
  { label: 'Fantasy', description: 'Svět založený na magii, mytologii, legendách nebo nadpřirozených silách.', theme: 'magie' },
  { label: 'Dark fantasy', description: 'Fantasy s temným, krutým nebo hororovým nádechem.', theme: 'temna-cerven' },
  { label: 'Heroic fantasy', description: 'Fantasy zaměřená na hrdinství, velké činy a epické střety.', theme: 'modre-nebe' },
  { label: 'Sword and sorcery', description: 'Dobrodružná fantasy s důrazem na akci, osobní motivace a menší měřítko.', theme: 'hospoda' },
  { label: 'Urban fantasy', description: 'Moderní nebo městské prostředí s existencí magie a nadpřirozena.', theme: 'kyberpunk' },
  ...
  { label: 'Soft sci-fi', description: 'Sci-fi více zaměřená na atmosféru, společnost nebo dobrodružství.', theme: 'sci-fi' },
  ...
  { label: 'Biopunk', description: 'Genetické zásahy, mutace, biologická kontrola a experimenty.', theme: 'priroda' },
  { label: 'Postapo', description: 'Svět po kolapsu civilizace.', theme: 'postapo' },
  { label: 'Post-postapo', description: 'Civilizace po kolapsu se znovu skládá do nových struktur.', theme: 'priroda' },
  { label: 'Dystopie', description: 'Společnost ovládaná represí, ideologií nebo totalitním systémem.', theme: 'severske-runy' },
  { label: 'Utopie / falešná utopie', description: 'Zdánlivě dokonalý svět s hlubším problémem.', theme: 'bila' },
  { label: 'Military', description: 'Svět zaměřený na armádu, válku, velení a ozbrojené konflikty.', theme: 'severske-runy' },
  ...
  { label: 'Psychologický horor', description: 'Horor zaměřený na vnitřní rozklad, trauma a mysl.', theme: 'nemrtvi' },
  { label: 'Lovecraftovský / kosmický horor', description: 'Neuchopitelné síly, šílenství, bezvýznamnost člověka.', theme: 'nemrtvi' },
  { label: 'Detektivní / mystery', description: 'Pátrání, vyšetřování, odhalování tajemství.', theme: 'mesic' },
  { label: 'Thriller', description: 'Napětí, tlak času, pronásledování, hrozba.', theme: 'temna-cerven' },
  ...
  { label: 'Alternativní historie', description: 'Historie se změnila jiným vývojem.', theme: 'pergamen' },
  { label: 'Steampunk', description: 'Průmyslová estetika, pára, ozubená kola, viktoriánská technika.', theme: 'hospoda' },
  { label: 'Dieselpunk', description: 'Tvrdší industriální styl, válka, meziválečná retro-moderní estetika.', theme: 'postapo' },
  { label: 'Mythic / mytologický', description: 'Svět silně opřený o konkrétní mytologii.', theme: 'indiane' },
  { label: 'Weird fiction', description: 'Zvláštní, zneklidňující a těžko zařaditelný svět.', theme: 'magie' },
  { label: 'Superhrdinský', description: 'Postavy s výjimečnými schopnostmi, maskami nebo ikonickou rolí.', theme: 'ctyri-zivly' },
  { label: 'Grimdark', description: 'Extrémně temný, cynický a brutální svět bez snadných řešení.', theme: 'temna-cerven' },
