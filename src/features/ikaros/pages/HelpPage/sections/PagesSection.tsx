...
const WORLD_PAGES_OK: PageDoc[] = [
  ...
  },
  {
    ...
    status: "ok",
    who: "Členové světa",
    what: "Adresář členů světa. Nahoře vedení — Pán jeskyně a Pomocní PJ —, pod tím skupiny a jejich členové, nakonec členové bez skupiny. Každý člen má kartu s avatarem, jménem a rolí — klik na ni otevře jeho osobní kartu (platformový profil). Pokud hráč v tomto světě hraje za postavu, je na kartě i řádek „Hraje za <postava>“ s avatarem postavy; klik na něj tě přenese přímo na stránku té postavy. Adresář otevřeš i kliknutím na dlaždici Hráčů na přehledu světa.",
  },
  {
  ...
  },
  {
    ...
    what: "Pravidla světa jako wiki stránka — příručka, kterou si Pán jeskyně (a Pomocný PJ) sám napíše a kdykoli upraví stejným editorem jako ostatní wiki stránky (text, obrázky, sekce). Otevřeš z horní lišty: Informace → Pravidla. Dokud nejsou nastavena, Pomocný PJ a výš uvidí tlačítko pro vytvoření pravidel, ostatní hlášku, že zatím nejsou nastavena. Vedle Pravidel jsou v Informace ještě dvě stejné referenční stránky — Magický systém (jak ve světě funguje magie) a Technologie (pokročilost techniky); obě vznikají s každým světem a PJ je může z menu skrýt v Nastavení → Viditelnost modulů.",
  },
  {
