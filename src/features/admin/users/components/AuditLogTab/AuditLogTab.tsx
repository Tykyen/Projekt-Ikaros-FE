...
const ACTION_LABELS: Record<AdminAuditAction, string> = {
  ...
  SUPPORTER_GRANT: 'Udělen status Podporovatel',
  SUPPORTER_REVOKE: 'Odebrán status Podporovatel',
  PERMISSIONS_CHANGE: 'Změna práv',
  ADMIN_PERMISSIONS_CHANGE: 'Změna oprávnění',
  USER_CREATE: 'Vytvoření účtu',
  ...
  DELETE: 'Smazání účtu',
  UNDELETE: 'Obnovení účtu',
  DELETION_REACTIVATED: 'Reaktivace mazání',
  HARD_DELETE: 'Trvalé smazání',
  ACCOUNT_SELF_DELETE_REQUEST: 'Žádost o smazání (vlastní)',
  ACCOUNT_DELETE_REQUEST: 'Žádost o smazání',
  ACCOUNT_DELETE_CANCEL: 'Zrušení žádosti o smazání',
  ACCOUNT_SELF_REACTIVATE: 'Vlastní reaktivace',
  ACCOUNT_HARD_DELETE: 'Trvalé smazání účtu',
  BULK_BAN: 'Hromadný ban',
  BULK_UNBAN: 'Hromadný unban',
  BULK_ROLE_CHANGE: 'Hromadná změna role',
  WORLD_ELEVATION_ACTIVATED: 'Nahození práv ve světě',
  WORLD_ELEVATION_REVOKED: 'Složení práv ve světě',
...
const ACTION_CLASS: Record<AdminAuditAction, string> = {
  ...
  SUPPORTER_GRANT: s.approved,
  SUPPORTER_REVOKE: s.rejected,
  PERMISSIONS_CHANGE: s.permissions,
  ADMIN_PERMISSIONS_CHANGE: s.permissions,
  USER_CREATE: s.approved,
  USERNAME_REQUEST_APPROVED: s.approved,
  USERNAME_REQUEST_REJECTED: s.rejected,
  FRIENDSHIP_COOLDOWN_RESET: s.approved,
  DELETE: s.ban,
  UNDELETE: s.unban,
  DELETION_REACTIVATED: s.roleChange,
  HARD_DELETE: s.ban,
  ACCOUNT_SELF_DELETE_REQUEST: s.roleChange,
  ACCOUNT_DELETE_REQUEST: s.roleChange,
  ACCOUNT_DELETE_CANCEL: s.unban,
  ACCOUNT_SELF_REACTIVATE: s.unban,
  ACCOUNT_HARD_DELETE: s.ban,
  BULK_BAN: s.ban,
  BULK_UNBAN: s.unban,
  BULK_ROLE_CHANGE: s.roleChange,
  WORLD_ELEVATION_ACTIVATED: s.roleChange,
  WORLD_ELEVATION_REVOKED: s.roleChange,
