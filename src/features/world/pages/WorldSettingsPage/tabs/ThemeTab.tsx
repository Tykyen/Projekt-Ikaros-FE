  ...
  async function save() {
    try {
      await mutation.mutateAsync({
        ...
        // D-NEW-theme-bg-empty (2026-05-21) — `null` = explicit clear ($unset na BE),
        // místo dřívějšího workaroundu `''`. Service.update handle null přes
        // worldsRepo.clearThemeBackgroundUrl().
        themeBackgroundUrl: backgroundUrl && backgroundUrl.trim() ? backgroundUrl : null,
      });
