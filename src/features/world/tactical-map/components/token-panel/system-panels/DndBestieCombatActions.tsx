 ...
 * iniciativu řeší rodič (DndBestiePanel mapy / DndChatBestiePanel chatu).
 */
import { calcMod, fmtMod, parseDamageFormula } from '@/features/world/pages/CharacterDetailPage/diary-systems/sheets/dnd5e/formulas';
import styles from './DndBestiePanel.module.css';

export interface DndBestieRollReq {
  label: string;
  modifier?: number;
  kind: 'd20' | 'mixed';
  critOnD20?: boolean;
...
interface Props {
  ...
  interactive: boolean;
  onRoll: (req: DndBestieRollReq) => void;
}

export function DndBestieCombatActions({
  ss,
  interactive,
  onRoll,
