...
| K-NAV8 | `RI` | 🟡 | legacy redirect `sprava-udalosti → ../akce` značený „1 měsíc" → po expiraci dluh; `/postava/:slug` necyklí | 04 | ✅ smazán 2026-06-20 (expiroval; `Navigate` import odebrán) |
