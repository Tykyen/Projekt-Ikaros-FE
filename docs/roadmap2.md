...
- **21.3g Krajina ✅ FE+BE (2026-07-14)** — třetí druh mapy 🌲 (plný generátor exteriérů): deterministický **value-noise (fBm)** → hory/kopce/les/mokřad/louka dle elevace+vlhkosti, řeka po spádu + jezero, **cesta greedy po nejnižším terénu** (přes vodu mosty, v každém sloupci mapy), volitelná **vesnička** (očíslovaná stavení + pole okolo), zeleň/tábor dle zabydlenosti. Buňky les·hory·kopce·pole·mokřad (+ reuse cesta/voda/most/budova), nástroje s canvas náhledy, legenda per druh. TM export: les+hory+budovy blokují výhled. Testy: 12 vitest (f+g) + BE 55 jest.
