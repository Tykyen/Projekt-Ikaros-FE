...
- **Co jde dělat / co se zobrazí:**
  ...
  - **Levý panel skrývá anonimovi slepé odkazy** (`anonHidden` filtr): „Vytvořit svět", „Diskuze", „Camp I.–III." (vedou jen na login) se anonimovi nezobrazí; CTA na tvorbu světa je místo toho v hero kartě. **Hospoda zůstává** viditelná (budoucí anon-chat 15.x; zatím klik → login).
