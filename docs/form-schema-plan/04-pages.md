...
> Globální `ValidationPipe({ whitelist:true, forbidNonWhitelisted:true, transform:true })` ([main.ts:53-56], PC-07) → neznámá/přejmenovaná pole vrátí **400** (akt. 2026-06-20; dřív „tiše strippnou bez 400").
