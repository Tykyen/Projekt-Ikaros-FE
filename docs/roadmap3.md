...
**Stav:** inventura funkcí přiznává „v prod refresh nejspíš nejede (cross-site cookie)".
**Kroky:** živě ověřit na prod (doména API vs web, SameSite); oprava dle nálezu (pravděpodobně doménová konfigurace, ne kód).
