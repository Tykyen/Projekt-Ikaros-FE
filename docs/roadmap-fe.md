...
- [x] **WS live update** — hotov v 9.4-I (FE subscribe na BE `weather.updated`).
- [ ] **Map integration broadcast** — čeká na fázi 10.2 (externí závislost).
