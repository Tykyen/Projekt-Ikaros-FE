...
2. **`server-check.yml`** → krok 13 ukáže RSS prerenderu proti limitu 768m; krok 14 restarty (`OOMKilled=false`). **Teprve tímhle je splněn bod ④ „ověřit RAM"** — nasazení limitu není totéž co měření.
