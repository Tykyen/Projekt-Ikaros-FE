# HANDOFF — Migrace Matrix → Ikaros (stav 2026-06-09, po F10)
...
| **F10** | **Obchod 255 položek (stránky DO_OBCHODU + ruční ceník GBP/USD). description=text stránky, referenceLink=slug, _id=page._id, isShared=true. PJ doplní skupiny/slevy.** | `import-matrix-shop.yml` | `_mig:f10` |
...
3. ~~**F9 akce**~~ ✅ HOTOVO (15 akcí, 2026-06-09) → **F11 chat** (25M, největší) — nechat nakonec.
