...
Když najdeš chybu, dluh, riziko nebo nesrovnalost, kterou hned neopravuješ, **okamžitě** ji zapiš do `docs/dluhy.md` (sekce "Otevřené"). Bez výjimky — nech kontext k vyřešení nikdy nezmizet. Detailní pravidla viz `.claude/rules/dluhy-log.md`.
